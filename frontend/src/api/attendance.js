...
export const getEnrollableStudents = (id, q, allDepartments = false) =>
  client.get(`/attendance/courses/${id}/enrollable-students/`, { params: { q, all_departments: allDepartments } })
